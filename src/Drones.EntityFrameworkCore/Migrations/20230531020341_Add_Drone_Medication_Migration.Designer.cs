...
namespace Drones.Migrations
{
    ...
    [Migration("20230531020341_Add_Drone_Medication_Migration")]
    partial class Add_Drone_Medication_Migration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Drones.Authorization.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Drones.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Drones.Models.DroneMedication", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Drones.MultiTenancy.Tenant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Drones.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Drones.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Drones.Authorization.Roles.Role", b =>
                {
                    b.HasOne("Drones.Authorization.Users.User", "CreatorUser")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");

                    b.HasOne("Drones.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("Drones.Authorization.Users.User", "LastModifierUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Drones.Models.DroneMedication", b =>
                {
                    b.HasOne("Drones.Models.Drone", "Drone")
                        .WithMany("DronesMedications")
                        .HasForeignKey("DroneId")
                        .IsRequired()
                        .HasConstraintName("FK_DronesMedications_Drone");

                    b.HasOne("Drones.Models.Medication", "Medication")
                        .WithMany("DronesMedications")
            ...
            modelBuilder.Entity("Drones.Models.Drone", b =>
                {
                    b.Navigation("DronesMedications");
                });

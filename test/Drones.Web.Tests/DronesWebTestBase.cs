...
{
    public abstract class DronesWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static DronesWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(DronesWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<DronesDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<DronesDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<DronesDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<DronesDbContext, Task<T>> func)
        {
            T result;
